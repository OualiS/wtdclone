...
const gh = new GitHub({ token: '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' });
...
const handlePullRequest = async (repo, ref, data) => {
  // this is where we'll post the git commit status message
    ...
    const completion = await openai.createChatCompletion({
      model: "gpt-3.5-turbo",
      messages : [
        {role : "system", content : "You are an expert in the field of computer science and you will make a verbose summary of the following diff from github. You will diplay your summary by file."}, {role : "user", content : ""},
